  ...
  $.ajax({
    ...
    success: (data) => {
      ...
      image.forEach(element => {
          ...
          image_path += '<li><a href="#?" class="'+ element.id +'" id="removeImg" aria-label="Remove Image"><i class="fa fa-trash"></i></a></li>'
          image_path += '<li><a href="#?" class="'+ element.id +'" id="makeProfile" aria-label="User as Profile"><i class="fa fa-user"></i></a></li>'
          image_path += '</ul>'
          image_path += '</div>'
          image_path += '</div>'
          count++
